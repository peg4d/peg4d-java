...
public abstract class Source {
	...
	public Source(String fileName, long linenum) {
...
//	public final static Source newStringSource(ParsingObject po) {
//		Source s = po.getSource();
//		return new StringSource(s.getResourceName(), s.linenum(po.getSourcePosition()), po.getText());
//	}

	public final static Source loadSource(String fileName) {
