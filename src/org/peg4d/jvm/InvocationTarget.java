...
public class InvocationTarget {
	...
	public InvocationTarget(InvocationType type, Class<?> ownerClass, 
	...
	public static InvocationTarget newStaticTarget(Class<?> ownerClass, 
			Class<?> returnClass, String methodName, Class<?>... paramClasses) {
		return new InvocationTarget(InvocationType.INVOKE_STATIC, ownerClass, 
