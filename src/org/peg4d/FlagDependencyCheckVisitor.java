...
public class FlagDependencyCheckVisitor extends GrammarVisitor{
	...
	public void visitRule(ParsingRule e) {
		...
		visitingRuleName = e.baseName;
		if(!this.flagDependencyMap.containsKey(visitingRuleName)){
			this.flagDependencyMap.put(visitingRuleName, new ArrayList<String>());
		}
	...
	public void visitNonTerminal(NonTerminal e) {
		if(!this.flagDependencyMap.containsKey(visitingRuleName)){
			this.visitRule(e.getRule());
		}
		List<String> visitingFlag = this.flagDependencyMap.get(visitingRuleName);
		for(String flag : this.flagDependencyMap.get(e.getRule().baseName)){
